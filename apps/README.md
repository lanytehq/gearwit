...
`apps/console/` begins as a browser-runnable projection with explicitly labeled
fixtures. Its future Tauri host attaches to or starts the same daemon used by
headless and CLI operation. Closing a window must not destroy registered
waits.
